...
show_results = Label(root)

def drivinglicense():
    driving_license_id = 198765439023
    print(type(driving_license_id))
    driving_license_name = "Suraj Sahoo"
    print(type(driving_license_name))
    driving_license_dob = "15-05-2011"
    print(type(driving_license_dob))
    driving_license_pin = 750012
    print(type(driving_license_pin))
    driving_license_address = "Odisha, Bhubaneswar"
    print(type(driving_license_address))
    driving_license_vechile = "Two Wheeler, Four Wheeler"
    print(type(driving_license_vechile))
    
    label_id["text"]= driving_license_id
    label_name["text"]= driving_license_name
    label_dob["text"]= driving_license_dob
    label_pin["text"]= driving_license_pin
    label_address["text"] = driving_license_address
    label_vehicle_type["text"]= driving_license_vechile 
    
button1 = Button(root, text = "Driving license", command= drivinglicense)
